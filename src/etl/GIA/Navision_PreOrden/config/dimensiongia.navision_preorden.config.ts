...
import query from './navision_preorden.query.json';

const uri = process.env.DATABASE_DIMENSIONGIA_COMPRA_URI;
const db = process.env.DATABASE_DIMENSIONGIA_COMPRA_SORUCE;
const collection = process.env.SOURCE_DIMENSIONGIA_COMPRA;
...
export const GiaNavisionPreOrdenConfig = {
  mongoUri: uri,
  mongoDb: db,
